...
# Setting up
```{r setting up files}
input_file <- href="https://TKMarkCheng.github.io/NormaliseForIC50/Validation/anomaly_detection/example1kcv2.xlsx" #CHANGE to example file in your directory for troubleshooting
input_directory <- href="https://TKMarkCheng.github.io/NormaliseForIC50/Validation/anomaly_detection" #CHANGE this to directory of input .xlsx data files
```
