...
# Setting up
```{r setting up files}
input_file <- here::here("NormaliseForIC50/main/Validation/anomaly_detection/example1kcv2.xlsx") #CHANGE to example file in your directory for troubleshooting
input_directory <- here::here("NormaliseForIC50/main/Validation/anomaly_detection") #CHANGE this to directory of input .xlsx data files
```
...
```{r example}
df <- NormaliseForIC50::read_promega_plate_excel(input_promega_excel_file_path = "https://raw.githubusercontent.com/TKMarkCheng/NormaliseForIC50/main/Validation/anomaly_detection/example1kcv2.xlsx")
df
```
