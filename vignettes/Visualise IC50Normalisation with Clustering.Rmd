...
# Setting up
```{r setting up files}
input_file <- "https://raw.githubusercontent.com/TKMarkCheng/NormaliseForIC50/main/Validation/anomaly_detection/example1kcv2.xlsx" #CHANGE to example file in your directory for troubleshooting
